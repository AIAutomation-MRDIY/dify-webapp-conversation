...
const Question: FC<IQuestionProps> = ({ id, content, imgSrcs, onEditSend }) => {
  ...
  return (
    <div className='group flex items-start justify-end' key={id}>
      ...
      <div className={`relative text-sm text-gray-900 dark:text-gray-100 ${isEditing ? 'flex-1' : 'max-w-[80%] pc:max-w-[70%]'}`}>
        {isEditing
          ? (
          ...
          : (
            <div className='py-3 px-4 bg-[#E1EFFE] dark:bg-[#27314D] rounded-2xl'>
